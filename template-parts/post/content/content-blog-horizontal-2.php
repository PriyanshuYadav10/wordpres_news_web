		...
		<div class="content-container">
			...
			<div class="meta-details">
				...
				<div class="author-name">
					...
					<span class="author-by"><?php esc_html_e( 'By ', 'blogsy-news' ); ?></span>
				...
				<span class="meta-item reading-time">
					...
					if ( $mins > 1 ) {
						echo intval( $mins ) . ' ';
						echo esc_html( Helper::get_option( 'translate_min_read' ) ) ?: esc_html__( 'Min Read', 'blogsy-news' );
					} else {
						echo esc_html( Helper::get_option( 'translate_one_min_read' ) ) ?: esc_html__( '1 Min Read', 'blogsy-news' );
					}
					?>
				</span>
				<?php endif; ?>
			...
			if ( post_password_required() ) {
				esc_html_e( 'This content is password protected. To view it please go to the post page and enter the password.', 'blogsy-news' );
			} elseif ( '1' === $blogsy_feed_type ) {
				printf( '<p class="excerpt">%s</p>', esc_html( $blogsy_excerpt ) );
			} else {
				printf( '<div class="excerpt">%s</div>', get_the_content( esc_html__( 'Continue reading', 'blogsy-news' ) ) );
			}
			?>
			<?php
