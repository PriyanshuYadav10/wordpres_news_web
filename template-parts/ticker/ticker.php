			...
			<div class="pt-col-12">
				<div class="blogsy-card-items blogsy-news-ticker-wrapper">
					...
					<div class="blogsy-news-ticker-title-wrapper">
						<span class="blogsy-news-ticker-title-icon-wrapper">
						<?php if ( 'layout-1' === $blogsy_ticker_type ) : ?>
								<span class="blogsy-news-ticker-title-pulse"></span>
							<?php else : ?>
								<?php echo \Blogsy\Icon::get_svg( 'bolt', 'ui' ); ?>
							<?php endif; ?>
						</span>
